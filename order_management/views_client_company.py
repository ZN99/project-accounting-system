    ...
    try:
        ...
        for company in companies:
            ...
            companies_data.append({
                ...
                'payment_offset_months': company.payment_offset_months,
                'payment_offset_months_label': company.get_payment_offset_months_display() if company.payment_offset_months is not None else '',
    ...
    if form.is_valid():
        ...
        return JsonResponse({
            ...
            'company': {
                ...
                'payment_day': company.payment_day,
                'payment_offset_months': company.payment_offset_months,
                'payment_offset_months_display': company.get_payment_offset_months_display() if company.payment_offset_months is not None else '',
                'default_key_handover_location': company.default_key_handover_location or '',
                'key_handover_notes': company.key_handover_notes or '',
